    ...
    return (
      <div>
        <section>
          <FrameBanner
            title="Select a room"
            desc="Welcome to LetsFakeNews, where you write fake-news on your phone then watch with friends on a screen. To start, choose your local news-room (use 'Public' if you're a visitor)."
          />
          <hr />
          <FrameForm
            rows="1"
